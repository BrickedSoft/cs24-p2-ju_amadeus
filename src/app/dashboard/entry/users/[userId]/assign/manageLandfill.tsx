...
const assignLandfill: FormInfo = {
  description: 'manage the Landfill sites management access for the current user.',
  title: 'Landfill manager',
};

const ManageLandfill: React.FC<{ params: { userId: string } }> = ({ params }) => {
  ...
  const AssignButton: React.FC<{ currLandfill: string }> = ({ currLandfill}) => {
    return (
      <Button
        onClick={(e) => {
          e.preventDefault();
  ...
  const RemoveButton: React.FC<{ currLandfill: string }> = ({ currLandfill }) => {
    return (
      <Button
        onClick={(e) => {
          e.preventDefault();
